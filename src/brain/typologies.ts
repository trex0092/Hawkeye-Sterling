...
export const TYPOLOGIES: Typology[] = [
  ...
  { id: 'pep', displayName: 'Politically Exposed Person', describes: 'Subject holds or recently held prominent public function.', redFlagIds: ['rf_pep_wealth_mismatch', 'rf_pep_family_nominee'], reasoningModes: ['pep_domestic_minister', 'narrative_coherence'], doctrines: ['wolfsberg_faq', 'uae_fdl_10_2025'] },
  ...
  { id: 'tipping_off', displayName: 'Tipping-off risk', describes: 'Risk that a customer or third party is alerted to an internal suspicion or investigation.', redFlagIds: [], reasoningModes: ['narrative_coherence', 'timeline_reconstruction'], doctrines: ['uae_fdl_10_2025'] },
