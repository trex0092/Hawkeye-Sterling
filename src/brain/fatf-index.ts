...
export const FATF_RECOMMENDATIONS: FatfRecommendation[] = [
  ...
  { id: 'R.3',  title: 'Money laundering offence', cluster: 'ml_tf_offences', reasoningModes: ['article_by_article', 'predicate_crime_cascade', 'environmental_predicate', 'tax_evasion_predicate', 'insider_trading_predicate', 'cyber_crime_predicate', 'human_trafficking_predicate'], doctrineIds: ['uae_fdl_20_2018'] },
