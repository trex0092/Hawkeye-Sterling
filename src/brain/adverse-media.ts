...
export const ADVERSE_MEDIA_CATEGORIES: AdverseMediaCategory[] = [
  ...
  {
    id: 'sanctions_violations',
    displayName: 'Sanctions Violations & Evasion',
    keywords: [
      'sanctions violation', 'sanctions breach', 'sanctions evasion', 'sanctions circumvention',
      'sanctions busting', 'sanction-busting', 'designated entity', 'designated person',
      'OFAC violation', 'OFAC penalty', 'OFAC enforcement', 'SDN listed', 'SDN designation',
      'EU sanctions violation', 'UK sanctions breach', 'UN sanctions violation',
      'asset freeze violation', 'asset freeze breach', 'funds freeze violation',
      'financial sanctions breach', 'correspondent bank sanction risk',
      'shell company sanctions evasion', 'front company sanctions',
      'sanctions deregistration', 'sanctions delisting', 'back-channel payments',
      'trade-based sanctions evasion', 'oil sanctions evasion',
      'gold sanctions evasion', 'SWIFT sanction circumvention',
      'deceptive shipping', 'AIS manipulation', 'dark vessel',
      'flag hopping', 'ship-to-ship transfer', 'petroleum sanctions',
      'Russia sanctions', 'Iran sanctions', 'DPRK sanctions', 'North Korea sanctions',
      'Venezuela sanctions', 'Myanmar sanctions', 'Cuba sanctions', 'Syria sanctions',
      'Belarus sanctions', 'Sudan sanctions', 'Libya sanctions',
      're-export sanctions violation', 'transshipment evasion',
      'secondary sanctions exposure', 'third-country sanctions facilitator',
      'proliferation sanctions', 'WMD proliferation financing',
      'Export Administration Regulations breach', 'EAR violation',
      'ITAR violation', 'dual-use export control breach',
    ],
  },
  {
    id: 'human_trafficking_modern_slavery',
    displayName: 'Human Trafficking & Modern Slavery',
    keywords: [
      'human trafficking', 'people trafficking', 'sex trafficking', 'labour trafficking',
      'forced labour', 'forced migration', 'debt bondage', 'bonded labour',
      'modern slavery', 'child labour', 'child exploitation', 'child sexual exploitation',
      'CSAM', 'child sexual abuse material', 'CSEM', 'child sexual exploitation material',
      'people smuggling', 'migrant smuggling', 'asylum seeker abuse',
      'domestic servitude', 'domestic slavery', 'agricultural forced labour',
      'fishing vessel forced labour', 'maritime slavery',
      'nail bar exploitation', 'car wash exploitation',
      'county lines', 'gang exploitation', 'criminal exploitation',
      'recruitment fraud', 'false job offer', 'deceptive recruitment',
      'document confiscation', 'passport confiscation',
      'victim of trafficking', 'survivor trafficking',
      'trafficking in persons', 'TIP report', 'US TIP report',
      'ILO forced labour indicators', 'Palermo Protocol breach',
      'proceeds of trafficking', 'trafficking proceeds',
      'sexual exploitation', 'commercial sexual exploitation',
      'online sexual exploitation', 'OSEC',
      'organised crime trafficking', 'trafficking network',
      'safe house trafficking', 'trafficking victim support',
    ],
  },
  {
    id: 'tax_crimes',
    displayName: 'Tax Crimes & Fiscal Fraud',
    keywords: [
      'tax evasion', 'tax fraud', 'tax avoidance abuse', 'aggressive tax planning',
      'offshore tax evasion', 'tax haven', 'tax shelter abuse', 'sham transaction',
      'abusive tax scheme', 'illegal tax shelter', 'tax gap',
      'VAT fraud', 'VAT carousel', 'missing trader fraud', 'MTIC fraud',
      'carousel fraud', 'cross-border VAT fraud', 'GST fraud',
      'transfer pricing abuse', 'profit shifting', 'base erosion',
      'BEPS violation', 'BEPS non-compliance',
      'undisclosed offshore account', 'hidden offshore account',
      'UBO concealment from tax authority', 'beneficial owner hiding',
      'trusts used for tax evasion', 'offshore trust abuse',
      'nominee director tax scheme', 'shell company tax evasion',
      'double Irish', 'Dutch sandwich', 'hybrid mismatch',
      'DAC6 breach', 'EU mandatory disclosure breach',
      'CRS non-compliance', 'FATCA non-compliance', 'FATCA evasion',
      'offshore banking secrecy', 'UBS tax case', 'HSBC tax case',
      'Panama Papers', 'Paradise Papers', 'Pandora Papers', 'FinCEN Files',
      'Swiss Leaks', 'LuxLeaks', 'OpenLeaks',
      'beneficial ownership register non-compliance',
      'CbCR non-compliance', 'country-by-country reporting breach',
      'pillar 2 non-compliance', 'global minimum tax evasion',
      'payroll tax fraud', 'employer tax fraud', 'customs duty fraud',
      'excise duty evasion', 'alcohol duty evasion', 'tobacco duty evasion',
    ],
  },
  {
    id: 'environmental_crime',
    displayName: 'Environmental Crime & Illegal Resource Extraction',
    keywords: [
      'environmental crime', 'eco crime', 'illegal mining', 'illegal logging',
      'illegal fishing', 'IUU fishing', 'unreported fishing', 'unregulated fishing',
      'illegal wildlife trade', 'wildlife trafficking', 'ivory trade', 'rhino horn',
      'shark fin', 'illegal timber', 'conflict timber', 'stolen timber',
      'environmental fraud', 'carbon credit fraud', 'voluntary carbon market fraud',
      'phantom carbon credit', 'ghost offset', 'double-counted carbon credit',
      'VCM fraud', 'carbon market manipulation', 'greenwashing prosecution',
      'emissions fraud', 'Paris Agreement fraud',
      'illegal waste export', 'hazardous waste dumping', 'e-waste crime',
      'Basel Convention violation', 'Rotterdam Convention breach',
      'illegal toxic waste', 'transboundary waste crime',
      'illegal resource extraction', 'artisanal mining crime', 'ASGM crime',
      'mercury trafficking', 'Minamata violation',
      'illegal oil dumping', 'marine pollution crime', 'ship discharge crime',
      'illegal land clearing', 'rainforest crime', 'peat burning crime',
      'biodiversity crime', 'illegal species trade', 'CITES violation',
      'INTERPOL environmental crime', 'financial flows from environmental crime',
      'proceeds of environmental crime', 'FATF environmental predicate',
      'deforestation crime', 'mining without permit', 'unlicensed mining',
      'CAHRA resource extraction', 'conflict minerals crime',
      'DRC mining crime', 'Sahel mining crime', 'Amazon illegal gold',
    ],
  },
  {
    id: 'drug_trafficking',
    displayName: 'Drug Trafficking & Narcotics',
    keywords: [
      'drug trafficking', 'narcotics trafficking', 'drug trade', 'illicit drug trade',
      'cartel', 'drug cartel', 'narco', 'narcos', 'narco-trafficking',
      'cocaine trafficking', 'heroin trafficking', 'methamphetamine trafficking',
      'fentanyl trafficking', 'opioid trafficking', 'synthetic drug trafficking',
      'cannabis trafficking', 'marijuana trafficking', 'khat trafficking',
      'precursor chemical trafficking', 'precursor diversion',
      'drug money', 'narco-dollars', 'drug proceeds',
      'drug money laundering', 'narco-laundering',
      'dark web drug market', 'darknet drug market', 'online drug market',
      'Silk Road', 'Hydra marketplace', 'AlphaBay',
      'drug mule', 'body packer', 'drug courier',
      'drug distribution network', 'drug supply chain',
      'trap house', 'county lines drug', 'county lines crime',
      'organized crime drug', 'gang drug trafficking',
      'Sinaloa cartel', 'Jalisco cartel', 'MS-13', 'CJNG',
      'Afghan heroin', 'Golden Triangle', 'Golden Crescent',
      'pill press', 'clandestine laboratory', 'drug lab',
      'MDMA laboratory', 'amphetamine factory',
      'bulk cash drug proceeds', 'drug cash smuggling',
