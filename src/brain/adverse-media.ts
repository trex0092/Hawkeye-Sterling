...
export const ADVERSE_MEDIA_CATEGORIES: AdverseMediaCategory[] = [
  ...
  },
  {
    ...
    keywords: [
      'environmental violation', 'pollution', 'toxic waste', 'oil spill',
      'illegal dumping', 'deforestation', 'illegal logging', 'illegal mining',
      'blood diamond', 'conflict mineral', 'ivory trade', 'wildlife trafficking',
      'poaching', 'greenwashing', 'carbon fraud', 'carbon credit fraud',
      'emissions fraud', 'sustainability fraud', 'ESG misrepresentation',
      'modern slavery', 'child labour', 'forced labour', 'sweatshop',
      'supply chain abuse', 'human rights abuse', 'indigenous rights',
      'union busting', 'workplace discrimination', 'sexual harassment',
      'board governance failure', 'audit failure', 'executive misconduct',
      'whistleblower retaliation', 'tailings dam collapse',
      'unsafe working conditions', 'LBMA non-conformance',
      'responsible-sourcing breach',
    ],
  },
  {
    id: 'cybercrime',
  ...
  },
  {
    ...
    keywords: [
      'deepfake', 'synthetic media', 'voice cloning', 'face-swap',
      'AI-generated content', 'AI fraud', 'AI scam', 'AI impersonation',
      'AI-enabled phishing', 'generative AI abuse', 'LLM jailbreak',
      'prompt injection', 'model poisoning', 'training-data poisoning',
      'adversarial attack', 'model theft', 'model exfiltration',
      'AI misinformation', 'AI disinformation', 'election deepfake',
      'AI-generated CSAM', 'synthetic identity', 'AI-assisted laundering',
      'autonomous fraud', 'bot farm', 'AI-driven account creation',
      'algorithmic bias', 'AI discrimination', 'hallucination misuse',
      'AI-enabled social engineering', 'chatbot impersonation',
