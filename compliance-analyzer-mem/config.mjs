/**
 * Configuration for the Compliance Analyzer Claude memory system.
 *
...
/** Observation categories for compliance analyzer workflows. */
 ...
 *
 *   L0 -- always loaded: project identity, regulatory thresholds, active alerts
 *   L1 -- session-relevant: recent screenings, approval decisions, pending filings
 *   L2 -- deep retrieval: historical decisions, archived reports, audit trail
 */
