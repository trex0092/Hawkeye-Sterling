...
Entity UNASSIGNED / Task 1214048871344703
=============================================================================

Document reference:   HSV2-TPK-2026-04-13-UNASSIGNED-Confirmed_Match_Regi
...
Coverage:             Pack generated for Asana task 1214048871344703 on 2026-04-13
...
Task name:         Confirmed Match Register — 2026 | All Entities
Task reference:    1214048871344703
...
Due date:          2026-05-31
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1214049679996137/task/1214048871344703

Task notes on file (first 1 000 characters):
Record any confirmed TFS match requiring immediate asset freeze and FIU notification. Fields: entity, customer/counterparty name, designation list, freeze date, assets frozen (type and value), FFR reference number filed on GOAML, MLRO escalation timestamp.
