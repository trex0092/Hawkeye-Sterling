...
Entity UNASSIGNED / Task 1214045708561016
=============================================================================

Document reference:   HSV2-TPK-2026-04-13-UNASSIGNED-PEP_Register_Review_
...
Coverage:             Pack generated for Asana task 1214045708561016 on 2026-04-13
...
Task name:         PEP Register Review — All Entities
Task reference:    1214045708561016
...
Due date:          2026-05-25
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1214049679934629/task/1214045708561016

Task notes on file (first 1 000 characters):
Review all PEP-flagged customer files. Confirm senior management approval for relationship continuation. Verify source of wealth documentation. Note: distinct from OPS-22 (PEP monitoring SOP) — this is the active PEP case register.

SECTION 2. AUTOMATION PRE-SCREEN

The automation pre-scan matched the following typology keywords: pep.
