...
Entity UNASSIGNED / Task 1214045708574621
=============================================================================

Document reference:   HSV2-TPK-2026-04-13-UNASSIGNED-EDD_Open_Cases_—_All
...
Coverage:             Pack generated for Asana task 1214045708574621 on 2026-04-13
...
Task name:         EDD Open Cases — All Entities | Status Review
Task reference:    1214045708574621
Project:           KYC / CDD TRACKER — ALL ENTITIES 2026
Reporting entity:  UNASSIGNED
Assignee:          Luisa Fernanda
Created:           2026-04-12
Due date:          2026-05-19
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1214049679934629/task/1214045708574621

Task notes on file (first 1 000 characters):
List all open EDD cases across all entities. Per UAE FDL No.10/2025, EDD is mandatory for PEPs, high-risk jurisdictions, and unusual transaction patterns. Each case must show: EDD rationale, senior management approval, source of wealth narrative, next review date. Note: distinct from OPS-17 (EDD trigger SOP) — this tracks live open cases.

SECTION 2. AUTOMATION PRE-SCREEN

The automation pre-scan matched the following typology keywords: highRiskJurisdiction, unusualPattern.
