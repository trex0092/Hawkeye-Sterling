...
Entity UNASSIGNED / Task 1214051378357246
=============================================================================

Document reference:   HSV2-TPK-2026-04-13-UNASSIGNED-UBO_Verification_Ref
...
Coverage:             Pack generated for Asana task 1214051378357246 on 2026-04-13
...
Task name:         UBO Verification Refresh — 12+ Month Declarations (All Entities)
Task reference:    1214051378357246
...
Due date:          2026-05-31
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1214049679934629/task/1214051378357246

Task notes on file (first 1 000 characters):
UBO verification refresh for all customers where UBO declarations are 12+ months old. Cross-check against UAE Register of Beneficial Owners. Note: distinct from OPS-12 (UBO Register SOP) — this tracks which specific files need refreshing.
