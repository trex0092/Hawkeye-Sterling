...
Entity UNASSIGNED / Task 1214051378340676
=============================================================================

Document reference:   HSV2-TPK-2026-04-13-UNASSIGNED-PNMR_Filed_Log_—_Apr
...
Coverage:             Pack generated for Asana task 1214051378340676 on 2026-04-13
...
Task name:         PNMR Filed Log — April 2026 | All Entities
Task reference:    1214051378340676
...
Due date:          2026-05-31
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1214049679996137/task/1214051378340676

Task notes on file (first 1 000 characters):
Log all Partial Name Match Reports filed on GOAML. Fields: screening date, entity, name matched, list, GOAML PNMR reference, filing date. Per UAE FIU guidance, PNMR must be filed within 48 hours of identification. Cross-reference with GOAML Reporting project.
