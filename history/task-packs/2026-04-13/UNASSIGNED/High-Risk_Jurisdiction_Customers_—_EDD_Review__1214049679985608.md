...
Entity UNASSIGNED / Task 1214049679985608
=============================================================================

Document reference:   HSV2-TPK-2026-04-13-UNASSIGNED-High-Risk_Jurisdicti
...
Coverage:             Pack generated for Asana task 1214049679985608 on 2026-04-13
...
Task name:         High-Risk Jurisdiction Customers — EDD Review
Task reference:    1214049679985608
...
Due date:          2026-05-30
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1214049679934629/task/1214049679985608

Task notes on file (first 1 000 characters):
Review EDD files for all customers with exposure to FATF grey-listed or blacklisted jurisdictions.

SECTION 2. AUTOMATION PRE-SCREEN

The automation pre-scan matched the following typology keywords: highRiskJurisdiction.
