...
Entity UNASSIGNED / Task 1213920295644359
=============================================================================

Document reference:   HSV2-TPK-2026-04-06-UNASSIGNED-[High]_REG-04_CNMR_T
...
Coverage:             Pack generated for Asana task 1213920295644359 on 2026-04-06
...
Task name:         [High] REG-04 | CNMR Terminology and Procedure Update (FFR to CNMR Migration)
Task reference:    1213920295644359
...
Due date:          2026-10-03
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1213908827982041/task/1213920295644359
...
Update all compliance documents, procedures, templates, and training materials to replace FFR (Funds Freeze Report) with CNMR (Confirmed Name Match Report) per the EOCN TFS Guidance July 2025.

Deliverables:
(1) Document inventory scan: identify every reference to FFR across Compliance Manual, SOPs, templates, training decks, Asana task descriptions, and FG-POL-AC-001
(2) Replace all FFR references with CNMR including updated procedural requirements: mandatory disclosure of all transactions/relationships with confirmed match in past 5 years, updated goAML filing steps for CNMR report type
(3) Update PNMR procedure to align with July 2025 clarifications: screening during weekends/holidays, disclosure of prior dealings
(4) Version control: update document version numbers for all amended documents
(5) Staff notification circular on terminology change
(6) Trigger Change Mana
