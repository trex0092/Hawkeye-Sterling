...
Entity UNASSIGNED / Task 1213920090751320
=============================================================================

Document reference:   HSV2-TPK-2026-04-06-UNASSIGNED-[High]_REG-07_Simpli
...
Coverage:             Pack generated for Asana task 1213920090751320 on 2026-04-06
...
Task name:         [High] REG-07 | Simplified Due Diligence (SDD) Procedure per MOE Circular No. (6) of 2025
Task reference:    1213920090751320
...
Due date:          2026-10-03
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1213908827982041/task/1213920090751320
...
Develop and document a Simplified Due Diligence (SDD) procedure in compliance with MOE Circular No. (6) of 2025 and the DNFBP Implementation Guide on CDD and CRA (November 2024).

Deliverables:
(1) SDD Eligibility Criteria: define customer/transaction types qualifying for SDD (lower-risk per BWRA/EWRA, specific product types, established counterparties with clean history)
(2) SDD Measures: reduced verification scope, simplified identity checks, adjusted ongoing monitoring frequency
(3) SDD Exclusion List: categories that NEVER qualify for SDD (PEPs, high-risk countries, cash over AED 55,000, CAHRA-origin, complex structures, new/untested counterparties)
(4) SDD-to-CDD/EDD Escalation Triggers: events that require immediate upgrade from SDD to standard CDD or EDD
(5) SDD Decision Form: documented rationale for applying SDD to each qualifying customer
(6) Integration with C

SECTION 2. AUTOMATION PRE-SCREEN

The automation pre-scan matched the following typology keywords: sanctions, cash, escalation.
