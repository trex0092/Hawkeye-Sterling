...
Entity UNASSIGNED / Task 1213920295644361
=============================================================================

Document reference:   HSV2-TPK-2026-04-06-UNASSIGNED-[Critical]_REG-02_HR
...
Coverage:             Pack generated for Asana task 1213920295644361 on 2026-04-06
...
Task name:         [Critical] REG-02 | HRC/HRCA Reporting Protocol and 3-Day Hold Procedure (goAML)
Task reference:    1213920295644361
...
Due date:          2026-10-03
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1213908827982041/task/1213920295644361
...
Establish procedure for filing High-Risk Country Transaction Reports (HRC) and High-Risk Country Activity Reports (HRCA) through the goAML portal.

Deliverables:
(1) HRC/HRCA Filing SOP documenting: trigger criteria (transaction/activity involving NAMLCFTC-designated high-risk country), filing steps in goAML, mandatory 3-working-day hold period before execution (transaction may only proceed if FIU does not object within 3 days)
(2) NAMLCFTC jurisdictions list saved locally with quarterly refresh schedule (source: https://www.namlcftc.gov.ae/en/more/jurisdictions/)
(3) Decision tree: HRC (completed transaction) vs HRCA (activity/attempted transaction) vs STR (suspicious element present)
(4) Template for HRC/HRCA report content
(5) Escalation protocol if FIU objects within 3-day hold
(6) Integration with transaction monitoring workflow (link to TM-01 alert triage)
