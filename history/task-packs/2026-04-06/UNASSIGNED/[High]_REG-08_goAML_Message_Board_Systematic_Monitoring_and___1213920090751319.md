...
Entity UNASSIGNED / Task 1213920090751319
=============================================================================

Document reference:   HSV2-TPK-2026-04-06-UNASSIGNED-[High]_REG-08_goAML_
...
Coverage:             Pack generated for Asana task 1213920090751319 on 2026-04-06
...
Task name:         [High] REG-08 | goAML Message Board Systematic Monitoring and Quarterly FIU Feedback Review
Task reference:    1213920090751319
...
Due date:          2026-10-03
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1213908827982041/task/1213920090751319
...
Establish systematic monitoring of the goAML Message Board for inbound FIU communications.

Deliverables:
(1) Daily monitoring checklist: CO/MLRO logs into goAML Message Board daily and documents any new messages (even if nil)
(2) Message classification system: RFI (requires response), Quarterly Feedback (requires review/action plan), System Notice (information only), Urgent Directive (immediate action)
(3) Quarterly FIU Feedback Review procedure: extract key findings, compare against own filing practices, document corrective actions, present summary to senior management
(4) Response tracking register: message date, type, reference, required action, response deadline, completion date, evidence
(5) Backup access: ensure deputy CO/MLRO has goAML access for Message Board monitoring during CO absence
(6) Monthly reporting to senior management on FIU communication activity

R

SECTION 2. AUTOMATION PRE-SCREEN

The automation pre-scan matched the following typology keywords: sanctions.
