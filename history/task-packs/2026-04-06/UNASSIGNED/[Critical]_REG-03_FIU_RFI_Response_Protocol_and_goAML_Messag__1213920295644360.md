...
Entity UNASSIGNED / Task 1213920295644360
=============================================================================

Document reference:   HSV2-TPK-2026-04-06-UNASSIGNED-[Critical]_REG-03_FI
...
Coverage:             Pack generated for Asana task 1213920295644360 on 2026-04-06
...
Task name:         [Critical] REG-03 | FIU RFI Response Protocol and goAML Message Board Monitoring SOP
Task reference:    1213920295644360
Project:           NAPLES LLC - COMPLIANCE PROGRAMME 2026
Reporting entity:  UNASSIGNED
Assignee:          Luisa Fernanda
Created:           2026-04-03
Due date:          2026-10-03
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1213908827982041/task/1213920295644360

Task notes on file (first 1 000 characters):
ENTITY: NAPLES LLC
PRIORITY: Critical
SOURCE: Regulatory Gap Analysis - MOE / FIU / EOCN Cross-Reference (3 April 2026)

Establish protocol for monitoring inbound FIU communications and responding to Requests for Information (RFI) through the goAML portal.

Deliverables:
(1) goAML Message Board Monitoring SOP: daily check by CO/MLRO (or designated deputy), log of all messages received, escalation for urgent FIU directives
(2) RFI Response Procedure: receipt acknowledgement within 24 hours, substantive response within 14 working days (or as specified by FIU), use of RFI report type in goAML quoting original STR/SAR web reference number
(3) AIF/AIFT Filing Procedure: when to file Additional Information File (no new transactions) vs Additional Information File with Transactions (new transactions to report), quoting original report reference in FIU Reference field
(4) Quarterly FIU Feedback Review: process for reviewing quarterly feedback reports from FIU, extracting action items, document

SECTION 2. AUTOMATION PRE-SCREEN

The automation pre-scan matched the following typology keywords: sanctions, escalation.
