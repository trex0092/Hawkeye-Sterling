...
Entity UNASSIGNED / Task 1213920090751318
=============================================================================

Document reference:   HSV2-TPK-2026-04-06-UNASSIGNED-[Medium]_REG-09_EOCN
...
Coverage:             Pack generated for Asana task 1213920090751318 on 2026-04-06
...
Task name:         [Medium] REG-09 | EOCN Grievance and Delisting Procedure: Customer Notification Protocol
Task reference:    1213920090751318
...
Due date:          2026-10-03
Completed:         no
Asana permalink:   https://app.asana.com/1/1213645083721316/project/1213908827982041/task/1213920090751318
...
Establish customer-facing procedure for notifying affected parties of TFS freezing measures and EOCN grievance/delisting procedures.

Deliverables:
(1) Customer Notification Template: scripted communication informing customer of freeze (without disclosing suspicion details), directing them to EOCN grievance procedures at https://www.uaeiec.gov.ae
(2) Internal decision tree: when to notify (confirmed match freeze), what to communicate (freeze fact + grievance channel only), what NOT to communicate (investigation details, suspicion basis)
(3) Delisting monitoring: when EOCN communicates delisting via goAML, procedure to lift TFS measures immediately (unless active separate Freeze Order from FIU/Public Prosecution)
(4) Staff training module on grievance notification (integrate with ACEP-18 CT-005)
(5) Legal review sign-off on notification template

Regulatory Basis: EOCN 

SECTION 2. AUTOMATION PRE-SCREEN

The automation pre-scan matched the following typology keywords: sanctions, training.
