  ...
  return (
    <ModuleLayout asanaModule="goaml-submission" asanaLabel="goAML STR Submission" onAdd={addTx}>
      <ModuleHero
        ...
        intro={
          <>
            ...
            under <strong>UAE Federal Decree-Law No. 10 of 2025 Art.17</strong> and the{" "}
          ...
          <div className="space-y-4">
            ...
            <FieldWrap label={`Narrative (${narrativeLen} / 4000 chars)`}>
              <textarea
                ...
                maxLength={4000}
                aria-required="true"
                placeholder="On [DATE], Hawkeye Sterling DPMS identified suspicious activity in account [ACCOUNT_NO] held by [CUSTOMER NAME]. Review of account activity from [START_DATE] to [END_DATE] revealed [DESCRIBE PATTERN]. The activity is inconsistent with the customer's stated business profile. Suspicion crystallised on [DATE] upon MLRO review. This STR is filed pursuant to UAE Federal Decree-Law No. 10 of 2025 Art.17 within 48 hours of crystallisation."
      ...
      <div className="mt-4 text-11 text-ink-3 font-mono">
        Regulatory basis: UAE Federal Decree-Law No. 10 of 2025 Art.17 · UAE FIU goAML Technical
