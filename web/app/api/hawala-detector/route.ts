...
export async function POST(req: Request) {
  ...
  try {
    ...
    void writeAuditChainEntry(
      { event: "hawala_detection_assessed", actor: gate.keyId, riskRating: result.riskRating, reportingRequired: result.reportingRequired, ivtsIndicatorCount: result.ivtsIndicators.length },
