...
export async function POST(req: Request) {
  ...
  try {
    const prompt = `You are a UAE AML/CFT compliance expert specialising in FIU engagement and STR/goAML feedback handling under UAE FDL 10/2025.

Process the following FIU feedback communication:
...
{
  "feedbackType": "acknowledgement"|"request-for-info"|"commendation"|"adverse",
  "keyPoints": string[],
  "requiredActions": string[],
  "responseDraft": string,
  "deadlineDays": number,
