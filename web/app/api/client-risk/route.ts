...
export async function POST(req: Request): Promise<NextResponse> {
  ...
  try { writeAuditEvent("compliance_assistant", "client-portal.ai-risk-assessment", entity.name); }
  ...
  try {
    ...
    const res = await client.messages.create({
        ...
        max_tokens: 700,
        system:
          "You are a UAE AML/CFT compliance analyst specializing in entity onboarding and CDD risk assessment for licensed DPMS/VASP under Federal Decree-Law No. 10 of 2025 Art.10, Cabinet Decision 58/2020, and FATF Recommendation 10. Assess this entity onboarding submission for ML/FT risk. Return ONLY valid JSON, no markdown fences.",
        messages: [
          {
            role: "user",
