    ...
    return NextResponse.json(
      {
        ...
        narrative: "⚠ Weaponized brain reasoning temporarily unavailable. Manual compliance review required under UAE Federal Decree-Law No. 10 of 2025 Art.19. Do not onboard or clear this subject without MLRO sign-off.",
        counterfactuals: [],
