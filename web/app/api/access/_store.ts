...
export const PERMISSION_LOG: PermissionLogEntry[] = [
  { id: "log-001", timestamp: "2025-04-20T14:30:00Z", actor: "System Administrator", action: "role_assigned", targetUserId: "usr-004", targetUserName: "Tariq Ibrahim", oldRole: "analyst", newRole: "supervisor", reason: "Appointed as Compliance Team Lead — expanded oversight responsibilities." },
];
