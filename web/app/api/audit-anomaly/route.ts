...
export async function POST(req: Request): Promise<NextResponse> {
  ...
  try {
    ...
    const res = await client.messages.create({
        ...
        max_tokens: 700,
        system:
          "You are a UAE AML internal audit specialist. Analyze this audit trail for suspicious access patterns, operational anomalies, and compliance gaps that could indicate insider threat, system manipulation, or procedural failures under Federal Decree-Law No. 10 of 2025 Art.21 and FATF R.18. Return ONLY valid JSON, no markdown fences.",
        messages: [
          {
            role: "user",
