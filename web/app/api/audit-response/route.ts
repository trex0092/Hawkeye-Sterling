...
export async function POST(req: Request) {
  ...
  try {
    ...
    const prompt = `You are a UAE AML/CFT compliance expert specialising in regulatory audit response preparation under FATF R.26-28 and UAE FDL 10/2025.

Prepare management responses to the following audit findings:
