...
Design a comprehensive AML compliance testing plan for this institution. Return complete ComplianceTestPlanResult JSON.`,
    ...
    void writeAuditChainEntry(
      { event: "compliance_test_plan.generated", actor: gate.keyId, testCount: result.testPlan.length, estimatedDuration: result.estimatedDuration, priorityAreaCount: result.priorityAreas.length },
