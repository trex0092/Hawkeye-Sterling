...
export async function POST(req: Request) {
  ...
  try {
    ...
    void writeAuditChainEntry(
      { event: "sanctions_exposure_calc", actor: gate.keyId, overallExposure: result.overallExposure, listHitCount: result.listExposures.length, debarmentRisk: result.debarmentRisk },
