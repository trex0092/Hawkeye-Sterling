...
// screen against under UAE Federal Decree-Law No. 10 of 2025, CBUAE AML Standards, and FATF
...
const REQUIRED_WATCHLISTS: WatchlistDefinition[] = [
  ...
  { id: "uae-eocn", name: "UAE Executive Office for Control & Non-Proliferation (EOCN)", authority: "UAE EOCN", mandatoryFor: ["DPMS","bank","VASP","DNFBPs","insurance"], regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.14; Cabinet Decision No. 10/2019", penaltyExposure: "critical", category: "sanctions", dataSource: "eocn.gov.ae (official)", updateFrequency: "real-time" },
  ...
  // ── PEP Lists ─────────────────────────────────────────────────────────────
  { id: "pep-class1", name: "PEP Category 1 — Heads of State / Government", authority: "FATF / Institutional", mandatoryFor: ["DPMS","bank","VASP","DNFBPs","insurance"], regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.12; FATF R.12", penaltyExposure: "critical", category: "pep", dataSource: "Refinitiv World-Check / Dow Jones / OpenSanctions (peps)", updateFrequency: "continuous" },
  { id: "pep-class2", name: "PEP Category 2 — Senior Government Officials", authority: "FATF / Institutional", mandatoryFor: ["DPMS","bank","VASP","DNFBPs","insurance"], regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.12; FATF R.12", penaltyExposure: "critical", category: "pep", dataSource: "Refinitiv World-Check / Dow Jones / OpenSanctions", updateFrequency: "continuous" },
  ...
  { id: "uae-ded", name: "Dubai DED Commercial Registry", authority: "Dubai DED", mandatoryFor: ["DPMS","bank","DNFBPs"], regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.8 (CDD); FATF R.10", penaltyExposure: "high", category: "corporate_registry", dataSource: "ded.gov.dubai (official)", updateFrequency: "real-time" },
  { id: "difc-registry", name: "DIFC Companies Registry", authority: "DIFC Registrar", mandatoryFor: ["bank","DNFBPs"], regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.8; FATF R.10", penaltyExposure: "medium", category: "corporate_registry", dataSource: "difclaw.org/companies-registry", updateFrequency: "weekly" },
  { id: "adgm-registry", name: "ADGM Companies Registry", authority: "ADGM Registrar", mandatoryFor: ["bank","DNFBPs"], regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.8; FATF R.10", penaltyExposure: "medium", category: "corporate_registry", dataSource: "adgm.com/companies", updateFrequency: "weekly" },
  // ── Adverse Media ─────────────────────────────────────────────────────────
  ...
  { id: "vasp-fatf", name: "FATF VASP Risk Indicators List", authority: "FATF", mandatoryFor: ["VASP","bank"], regulatoryBasis: "FATF R.15 (VASPs); Federal Decree-Law No. 10 of 2025 Art.20", penaltyExposure: "critical", category: "onchain", dataSource: "Chainalysis / TRM Labs / Elliptic", updateFrequency: "continuous" },
...
async function handler(req: Request): Promise<NextResponse> {
  ...
  return NextResponse.json({
    ...
    aiRecommendations,
    regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.14; CBUAE AML Standards §7; FATF R.6, R.10, R.12",
