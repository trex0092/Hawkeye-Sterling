...
export async function POST(req: Request) {
  ...
  try {
    ...
    const prompt = `You are a UAE AML/CFT legal expert specialising in asset freezing and seizure procedures under UAE FDL 10/2025 and FATF standards.

Analyse the following asset freeze/seizure scenario:
