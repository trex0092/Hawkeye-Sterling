...
const FALLBACK: InterAgencyReferralResult = {
  ...
  referralPackage: {
    ...
    legalBasis: "UAE FDL 10/2025 Art.2 (ML offence), Art.17(3) (mandatory referral where criminal investigation warranted); UAE Federal Law 4/2002 Art.2 (ML offence), Art.8 (restraint orders), Art.9 (confiscation); Cabinet Decision 10/2019; UAE Penal Code",
    requestedActions: [
