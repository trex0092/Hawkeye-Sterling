  ...
  obligations: [
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.17; CR 134/2025 Art.14 (AED 55,000 threshold)",
    ...
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.17(1); FATF R.20",
      filingMethod: "goAML portal — STR submission form with narrative, transaction details, and subject information",
      notes: "The 2-business-day clock starts from MLRO determination, not from when the alert was first generated. Do not tip off the customer (Federal Decree-Law No. 10 of 2025 Art.20). STRs can be filed for attempted transactions that were declined.",
      category: "reporting",
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.23; Cabinet Decision 74/2020 (targeted financial sanctions); UNSCR 1267 (Al-Qaeda/ISIL) and UNSCR 1373 (terrorism)",
    ...
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.5; CBUAE AML/CFT Guidelines §3; FATF R.1",
    ...
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.20; CBUAE AML Training Requirements; FATF R.18",
      ...
      notes: "100% completion is required — no exemptions. Training must be updated to reflect regulatory changes (e.g., Federal Decree-Law No. 10 of 2025). Role-specific training required for MLRO, compliance team, and relationship managers. MLRO must complete CBUAE-approved specialist training.",
      category: "training",
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.5(2); CBUAE AML/CFT Guidelines §3.2",
    ...
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.17; CBUAE goAML Circular",
    ...
    },
    {
      ...
      legalBasis: "CBUAE Prudential Returns Framework; UAE Federal Decree-Law No. 10 of 2025 Art.5",
    ...
    },
    {
      ...
      legalBasis: "Cabinet Decision 58/2020 (UBO Register); UAE Federal Decree-Law No. 10 of 2025 Art.11",
    ...
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.5; CBUAE AML/CFT Guidelines §2; FATF R.18",
      ...
      notes: "AML Policy must be updated to reflect UAE Federal Decree-Law No. 10 of 2025 (in force 14 Oct 2025). Must include: EWRA methodology, CDD/EDD procedures, STR/CTR procedures, PEP policy, tipping off prohibition, sanctions procedures, and PF provisions.",
      category: "review",
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.5; CBUAE AML/CFT Guidelines §8; FATF R.18",
    ...
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.9 (MLRO appointment requirements); CBUAE No-Objection requirements for MLRO",
    ...
    },
    {
      ...
      legalBasis: "Cabinet Decision 74/2020 (TFS implementation); UN Security Council Resolutions; UAE Federal Decree-Law No. 10 of 2025 Art.23",
    ...
    },
    {
      ...
      legalBasis: "UAE Federal Decree-Law No. 10 of 2025 Art.15 (ongoing monitoring); FATF R.10 (ongoing due diligence); CBUAE AML/CFT Guidelines §4.4",
...
export async function POST(req: Request) {
  ...
  void writeAuditChainEntry(
    { event: "regulatory-calendar_accessed", actor: gate.keyId },
