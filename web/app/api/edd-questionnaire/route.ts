...
const FALLBACK: EddQuestionnaire = {
  eddLevel: "enhanced",
  eddBasis: "PEP exposure / High-risk jurisdiction / DPMS gold trader — EDD mandatory under Federal Decree-Law No. 10 of 2025 Art.13",
  totalQuestions: 12,
  mandatoryCount: 8,
  categories: ["Identity & Ownership", "Source of Funds", "Business Purpose", "PEP Declarations", "Sanctions"],
  questions: [
    { id: "1", category: "Identity & Ownership", question: "Provide certified UBO declaration identifying all beneficial owners holding ≥25% (FATF threshold) or ≥25% effective control.", rationale: "Beneficial ownership verification mandatory for all DPMS clients.", regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.8; Cabinet Resolution 134/2025 §3.2", mandatory: true, followUp: "For each UBO: passport copy, proof of address, source of wealth." },
    { id: "2", category: "Source of Funds", question: "Provide documentary evidence of the source of funds for all transactions (e.g., audited accounts, bank statements, trade invoices).", rationale: "SoF verification mandatory for DPMS high-risk clients.", regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.11; FATF R.10", mandatory: true },
    ...
    { id: "4", category: "Business Purpose", question: "Describe the nature of business and primary revenue-generating activities including geographic markets served.", rationale: "Business relationship purpose documented for AML risk assessment.", regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.8(1)(c)", mandatory: true },
    { id: "5", category: "PEP Declarations", question: "Confirm whether the entity or any UBO, director, or senior officer is a Politically Exposed Person (PEP) or a family member / close associate of a PEP.", rationale: "PEP screening is mandatory and triggers EDD per FATF R.12.", regulatoryBasis: "FATF R.12; Federal Decree-Law No. 10 of 2025 Art.10", mandatory: true },
    { id: "6", category: "Sanctions", question: "Confirm that none of the UBOs, counterparties, or correspondent relationships are subject to UAE EOCN, UN, US OFAC, EU, or UK OFSI sanctions.", rationale: "Sanctions nexus check required before onboarding.", regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.14; EOCN Cabinet Decision 74/2020", mandatory: true },
    { id: "7", category: "Identity & Ownership", question: "Provide corporate structure chart showing all layers of ownership up to the ultimate parent and all entities with >10% shareholding.", rationale: "Complex structures may indicate layering risk.", regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.8; FATF R.24", mandatory: true },
    { id: "8", category: "Business Purpose", question: "Provide last 3 years of audited financial statements or tax filings to evidence business scale and financial position.", rationale: "Expected transaction volumes must be proportionate to stated business.", regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.8(1)(d)", mandatory: true },
  ],
  ...
  regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.10, Art.13; Cabinet Resolution 134/2025; FATF R.10, R.12",
};
