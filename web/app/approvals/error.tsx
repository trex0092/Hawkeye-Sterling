...
// MISSING-LOAD-002 (forensic audit batch 3) — segment error boundary.
// Without this, a thrown error inside the approvals tree falls through to
// the root error.tsx and shows the generic "Something went wrong" screen
// with no context about WHICH compliance flow failed. Reviewers / MLROs
// need the segment label to know whether to retry or escalate.
      ...
      <div className="max-w-md text-center px-6">
        ...
        <p className="text-13 text-ink-2 mb-6 leading-relaxed">
          {process.env.NODE_ENV !== "production"
            ...
            : "An unexpected error occurred. Please try again or contact your MLRO if the problem persists."}
        </p>
