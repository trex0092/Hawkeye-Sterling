    ...
    <div>
      ...
      {sessions.length === 0 ? (
        ...
        <div className="border border-hair-2 rounded-md overflow-x-auto">
          <table className="w-full min-w-[320px] text-12">
            <thead>
              <tr className="border-b border-hair bg-bg-2">
                ...
                <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2 hidden sm:table-cell">IP</th>
                <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2 hidden sm:table-cell">Started</th>
                <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2 hidden md:table-cell">Last Active</th>
            ...
            <tbody>
              {sessions.map((s, i) => (
                <tr key={s.id} className={`border-b border-hair last:border-0 ${i % 2 === 0 ? "" : "bg-bg-2/30"}`}>
                  ...
                  <td className="px-4 py-2.5 font-mono text-ink-2 hidden sm:table-cell">{s.ipDisplay}</td>
                  <td className="px-4 py-2.5 text-ink-2 hidden sm:table-cell">{fmtDate(s.started)}</td>
                  <td className="px-4 py-2.5 text-ink-2 hidden md:table-cell">{fmtDate(s.lastActive)}</td>
                  <td className="px-4 py-2.5">
                    {s.active ? (
...
export default function AccessControlPage() {
  ...
  return (
    <ModuleLayout engineLabel="Access control engine" asanaModule="access-control" asanaLabel="Access & Permissions" onAdd={() => setShowAddForm(true)}>
      <ModuleHero
            ...
            <table className="w-full min-w-[320px] text-12">
              <thead>
                <tr className="border-b border-hair bg-bg-2">
                  ...
                  <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2 hidden sm:table-cell">Username</th>
                  <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2 hidden md:table-cell">Email</th>
                  <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2">Role</th>
                  <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2 hidden sm:table-cell">Last login</th>
                  <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2">Status</th>
                </tr>
              </thead>
              <tbody>
                {users.map((u, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-ink-1 font-mono text-11 hidden sm:table-cell">{u.username ?? <span className="text-ink-3">—</span>}</td>
                    <td className="px-4 py-3 text-ink-2 font-mono text-11 hidden md:table-cell">{u.email}</td>
                    <td className="px-4 py-3">
                      <RoleBadge role={u.role} />
                    </td>
                    <td className="px-4 py-3 text-ink-2 hidden sm:table-cell">{fmtDate(u.lastLogin)}</td>
                    <td className="px-4 py-3">
                      <span
            ...
            <table className="w-full min-w-[320px] text-12">
              <thead>
                <tr className="border-b border-hair bg-bg-2">
                  ...
                  <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2 hidden sm:table-cell">
                    Actor
                  </th>
                  <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2">
                    Action
                  ...
                  <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2 hidden md:table-cell">
                    Role change
                  </th>
                  <th className="text-left px-4 py-2.5 text-10 font-mono uppercase tracking-wide-4 text-ink-2 hidden md:table-cell">
                    Reason
              ...
              <tbody>
                {[...log].reverse().map((entry, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-ink-1 hidden sm:table-cell">{entry.actor}</td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3 text-ink-2 max-w-[240px] truncate hidden md:table-cell" title={entry.reason}>
                      {entry.reason}
                    </td>
                  </tr>
                ))}
