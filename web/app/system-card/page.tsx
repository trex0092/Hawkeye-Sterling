        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            {[
              ...
              "Adverse media: GDELT lifetime corpus (no date cap) + 12-vendor news fan-out with tone scoring + LSEG CFS adverse-categorised index across 41 categories (money laundering, terrorism financing, fraud, corruption, narcotics, trafficking, organised crime, cybercrime, environmental crime, weapons proliferation, modern slavery, regulatory enforcement, litigation, tax evasion, sanctions evasion, financial crime, precious metals crime, real estate crime, crypto asset crime, counterfeiting, illicit trade, banking crime, insurance crime, healthcare & pharma crime, immigration crime, sports crime, charity abuse, gambling crime, war crimes, extortion & kidnapping, energy crime, pension fraud, bankruptcy fraud, aviation & shipping crime, food crime, education fraud, labour crime, media crime, data crime, corporate governance crime, sanctions circumvention, market abuse, political exposure, AI misuse, insider threat)",
