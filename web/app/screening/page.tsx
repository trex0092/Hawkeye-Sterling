...
export default function ScreeningPage() {
  ...
  return (
    <>
      <Header />
      <ModuleActionBar asanaModule="screening" asanaLabel="Screening" onCsv={exportFilteredCsv} onRun={() => void runBulkRescreen()} onAdd={() => setFormOpen(true)} onSync={_handleRefresh} />
