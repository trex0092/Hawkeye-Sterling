...
// MISSING-LOAD-005 (forensic audit batch 3) — Intel Feed segment error
// boundary. Regulator RSS / adverse-media network failures previously fell
// through to the root error.tsx with no source context.
      ...
      <div className="max-w-md text-center px-6">
        ...
        <p className="text-13 text-ink-2 mb-6 leading-relaxed">
          {process.env.NODE_ENV !== "production"
            ...
            : "The intelligence feed could not be loaded. Try again or check the upstream provider status."}
        </p>
