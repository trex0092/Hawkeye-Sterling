...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "📋 OECD DDG", href: "/oecd-ddg", hint: "OECD Due Diligence Guidance · 5-step framework" },
      { label: "🗄️ RMAP Database", href: "/rmap", hint: "RMAP conformant smelter database" },
      { label: "🥇 LBMA Gold", href: "/lbma", hint: "LBMA Responsible Gold · supply chain declarations" },
      ...
      { label: "🔭 Operator Console", href: "/operator", hint: "Audit trail & operator console" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "🗺️ Risk Map", href: "/country-risk-map", hint: "Country risk heat-map · global risk overview" },
