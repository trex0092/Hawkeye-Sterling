...
export const JURISDICTIONAL_CONFLICTS: JurisdictionalConflict[] = [
  {
    ...
    authorities: ["EU GDPR Art.17", "UAE Federal Decree-Law No. 10 of 2025 Art.16", "UAE PDPL 45/2021 Art.12"],
  },
  {
    ...
    authorities: ["EU CSDDD (Directive 2024/1760)", "FATF Recommendation 1", "UAE Federal Decree-Law No. 10 of 2025"],
  },
  {
    ...
    severity: "high",
    description:
      "FATF R.21 and UAE Federal Decree-Law No. 10 of 2025 Art.25 criminalise tipping-off — disclosing to a subject that an STR has been or will be filed. Under EU 5AMLD/6AMLD, customers have certain access rights. Confirming an STR filing in response to a subject-access request would breach the tipping-off prohibition.",
    mitigation: [
    ...
    authorities: ["FATF R.21 (INR.21)", "UAE Federal Decree-Law No. 10 of 2025 Art.25", "EU 5AMLD Art.41"],
  },
  {
    ...
    authorities: ["UN Consolidated List", "OFAC SDN List", "UAE EOCN guidance", "UAE Federal Decree-Law No. 10 of 2025"],
  },
  {
