...
const SEED_BREACHES: Omit<BreachRecord, "breachId" | "loggedAt" | "dueDate" | "status">[] = [
  ...
  },
  {
    ...
    regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.18 — MLRO must investigate and decide within 5 days of alert",
    owner: "MLRO",
  },
  {
    loggedBy: "system",
    ...
    regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.16 — four-eyes dual-approval process must be completed for all STR/freeze actions",
    owner: "MLRO",
  },
  {
    loggedBy: "system",
    ...
    regulatoryBasis: "Federal Decree-Law No. 10 of 2025 Art.18 — MLRO must investigate and decide within 5 days of screening.completed event",
    owner: "MLRO",
  },
  {
    loggedBy: "system",
