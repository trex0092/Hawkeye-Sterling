...
const SUPPLEMENT: Record<string, Supplement> = {
  ...
  goaml: {
    purpose: "goAML XML export for FIU submission (STR/SAR/CTR and related report types).",
    control: "Exports validated against the goAML schema; tipping-off egress gate enforced before any external release.",
    obligation: "STR filing via goAML — Cabinet 10/2019 Art.17; CBUAE Notice 2021/8; FATF R.20/R.23.",
...
const SECTIONS_OVERRIDE: Record<string, readonly string[]> = {
  ...
  goaml: ["📥 New Exports", "✏️ Draft XML", "🔍 MLRO Review", "📤 Submitted to FIU", "✅ Acknowledged"],
