...
//
// listId values use lowercase_underscore format matching the canonical
// adapter IDs in candidates-loader.ts so the API route's critical-list
// check (ofac_sdn, un_consolidated) passes when Blobs is unavailable.
export const CANDIDATES: QuickScreenCandidate[] = [
  ...
  { listId: "ofac_sdn", listRef: "OFAC-SDN-VESSEL-1041", name: "Vessel PEGAS (IMO 9256858)",
    aliases: ["PEGAS tanker", "Lana tanker"], entityType: "vessel",
    jurisdiction: "IR", programs: ["IRAN-OIL"] },
  { listId: "un_consolidated", listRef: "UN-PoE-KP-V-2023-18", name: "Vessel WISE HONEST (IMO 9245601)",
