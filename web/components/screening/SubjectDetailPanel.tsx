...
// is wired.
const TABS = ["Screening", "Adverse Media", "Evidence"] as const;
...
export function SubjectDetailPanel({ subject, onUpdate, allSubjects, onSelectSubject, triageResolutions }: SubjectDetailPanelProps) {
  ...
  // Role/narrative overrides lived on the removed Live-reasoning tab; the
  // super-brain call now always runs on the unmodified adverse-media text.
