  ...
  return (
    <div className="mb-8">
      ...
      <p className="max-w-[68ch] text-ink-1 text-13.5 leading-[1.6] m-0 mt-3 border-l-2 border-brand pl-3.5">
        ...
        traced to the modes that produced it. Amplifier v3.7.0 — 76 directives · 100% coverage · multilingual screening · behavioral deviation · cross-asset wealth · FinTech/CBDC · trade-finance fraud · kleptocracy · OCG mapping · FATF IO · zero-day emerging-threat protocol.
      </p>
    </div>
  );
}
