  ...
  return (
    <div className="mb-8">
      ...
      <p className="max-w-[68ch] text-ink-1 text-13.5 leading-[1.6] m-0 mt-3 border-l-2 border-brand pl-3.5">
        ...
        traced to the modes that produced it. Amplifier v3.8.0 — 86 directives · mining supply chain · conflict minerals · human rights HRDD · forced labour · greenwashing · EU Taxonomy/SFDR/TCFD · TNFD biodiversity · UAE gold souk · ESG governance integrity.
      </p>
    </div>
  );
}
