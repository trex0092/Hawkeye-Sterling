...
| Folder | Contents |
|---|---|
| `scripts/` | 45 Node.js scripts that drive the automation, plus `lib/report-scaffold.mjs` shared helpers and `regulatory-context.mjs` single source of truth for the UAE legal framework. See `scripts/README.md`. |
| `.github/workflows/` | 40 GitHub Actions workflows that schedule and dispatch each script. |
